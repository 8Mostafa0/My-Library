...
namespace My_Library.ViewModel
{
    public interface IBooksViewModel : IViewModelBase
    {
        ...
        static abstract IBooksViewModel LoadViewModel(IBooksStore booksStore, LoanRepository loanRepository, IReservedBooksRepository reservedBooksRepository, BooksRepository booksRepository);
