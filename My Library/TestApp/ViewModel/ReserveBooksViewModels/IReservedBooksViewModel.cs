...
namespace My_Library.ViewModel.ReserveBooksViewModels
{
    public interface IReservedBooksViewModel : IViewModelBase
    {
        ...
        static abstract IReservedBooksViewModel LoadViewModel(IReservedBooksStore reservedBooksStore, ModalNavigationStore modalNavigationStore, ClientsStore clientsStore, BooksStore booksStore, LoanRepository loansRepository, ClientsRepository clientsRepository, ReservedBooksRepository reservedBooksRepository);
    }
}