...
namespace My_Library.ViewModel.ReserveBooksViewModels
{
    public class ReservedBooksViewModel : ViewModelBase, IReservedBooksViewModel
    {
        ...
        public ReservedBooksViewModel(IReservedBooksStore reservedBooksStore, IModalNavigationStore modalNavigationStore, IClientsStore clientsStore, IBooksStore booksStore, ILoanRepository loansRepository, ClientsRepository clientsRepository, IReservedBooksRepository reservedBooksRepository)
        {
            _reservedBooks = [];
        ...
        /// <returns></returns>
        public static IReservedBooksViewModel LoadViewModel(IReservedBooksStore reservedBooksStore, IModalNavigationStore modalNavigationStore, IClientsStore clientsStore, IBooksStore booksStore, ILoanRepository loansRepository, ClientsRepository clientsRepository, IReservedBooksRepository reservedBooksRepository)
        {
