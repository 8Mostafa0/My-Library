...
namespace My_Library.Command.LoansCommands
{
    public class ShowEditLoanViewModel : CommandBase
    {
        ...
        public ShowEditLoanViewModel(IModalNavigationStore modalNavigationStore, ILoansStore loansStore, BooksStore booksStore, ClientsStore clientsStore, ILoansViewModel loansViewModel, LoanRepository loanRepository, ISettingsStore settingsStore, BooksRepository booksRepository, ReservedBooksRepository reservedBooksRepository)
        {
