...
namespace My_Library.Command.ClientsCommands
{
    public class NavigateClientScreenCommand : CommandBase, INavigateClientScreenCommand
    {
        ...
        public NavigateClientScreenCommand(INavigationStore navigationStore, IClientsStore clientsStore, ILoanRepository loanRepository, IReservedBooksRepository reservedBooksRepository)
        {
